      ...
      <div className="learn-container">
        <div className="learn-hero">
          <div className="learn-text">
            <h1>Learn.</h1>
            <p>
              From the fundamentals of planetary transits to Machine Learning tools, dive into interactive lessons and challenges. Empower your curiosity and become part of the next generation of explorers.
            </p>
